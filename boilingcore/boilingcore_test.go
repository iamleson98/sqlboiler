...
import (
	...
	"github.com/iamleson98/sqlboiler/v4/importers"
	"github.com/volatiletech/strmangle"

	"github.com/iamleson98/sqlboiler/v4/drivers"
	"github.com/iamleson98/sqlboiler/v4/drivers/mocks"
)
...
func testNew(t *testing.T, aliases Aliases) {
	...
	cmd = exec.Command("go", "mod", "init", "github.com/iamleson98/sqlboiler-test")
	...
	cmd = exec.Command("go", "mod", "edit", fmt.Sprintf("-replace=github.com/iamleson98/sqlboiler/v4=%s", filepath.Dir(string(goModFilePath))))
	cmd.Dir = state.Config.OutFolder
	cmd.Stderr = buf
